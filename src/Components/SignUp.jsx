        ...
        <Form>
          <Form.Row>
            <Form.Group as={Col}>
              ...
              <Form.Control type="text" placeholder="Ex. John" id="firstName" />
            </Form.Group>
          </Form.Row>
          <Form.Row>
            <Form.Group as={Col}>
              <Form.Label htmlFor="Last Name">Last Name </Form.Label>
              <Form.Control placeholder="Ex: Smith" type="text" id="lastName" />
            </Form.Group>
          </Form.Row>
          <Form.Row>
            <Form.Group as={Col}>
          ...
          <Form.Row>
            <Form.Group as={Col} controlId="formGridArea">
              ...
              <Form.Control as="select" required defaultValue="Select Gender">
          ...
          <Form.Row>
            <Form.Group as={Col} controlId="formGridArea">
              ...
              <Form.Control as="select" required defaultValue="Choose Country">
